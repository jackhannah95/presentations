...
date: "1 October 2019 <br><br> Slides: https://github.com/jackhannah95/presentations/tree/main/2019-10-01_unit-testing"
output:
...
include_graphics(here::here("2019-10-01_unit-testing", "images", "pill-test.jpg"))
```
<center>
...
include_graphics(here::here("2019-10-01_unit-testing", "images", "testthat_logo.png"))
```
...
```{r}
test_file(here::here("2019-10-01_unit-testing", "code", "02_test-n_day.R"))
```
